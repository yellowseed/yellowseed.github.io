...
<div id="impact-page">
  ...
  <div class="impact-banner banner">
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-12">
          <h1>Yellow Seed is committed to measurable and meaningful impact.</h1>
          <p>We're a community working together to create resilience in both our global food systems
            and local communities, while preserving rainforests and increasing farmer incomes.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-11 offset-md-1">
          <h2 class="big-lh mt-5">There are 5 million farmers across the world who depend on cacao for their
            livelihoods.</h2>
          <p>We represent 3720 of those cacao farmers from 33 origins
            and 20 countries.</p>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <google-map name="stylish" class='stylishMap'>
    </google-map>
</div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-sm-8 col-sm-offset-1 mb-4">
        ...
        <h2 class="big-lh">Fostering equitable market conditions is key to improving livelihoods.</h2>
        <p>When farmers sell their product under equitable market conditions they receive a fair price, improved terms,
          and a social premium that values skills offered, promotes self-agency and creates the opportunity for farmers
          to develop their businesses and plan for their future. This produces a powerful way to reduce poverty and
  ...
  <div class="container">
    <div class="row top50 mb-4">
      <div class="col-12 col-sm-8 offset-sm-3">
        ...
        <h2 class="big-lh">Increased income helps communities to invest in healthcare, education, and training.</h2>
        <p>Research has shown that as farmer incomes increase, the surrounding communities will grow and prosper. The
          domino effect of having more finances flowing in a system, translates to farmers investing in the education of their
          children, opting for increased health care services and taking part in more training programs related to their business endeavors.</p>
      </div>
    </div>
    <div class='row'>
  ...
  <div class="container">
    <div class="row mb-4">
      <div class="col-12 col-sm-8 col-sm-offset-1 col-md-offset-1">
        ...
        <h2 class="big-lh">Supporting sustainable farming is a proven method for protecting forests, increasing
          biodiversity, and adapting to climate change.</h2>
        <p>When farmers are financially valued for their role in the ecological system, he planet wins. Ecological
          farming ensures healthy farmland and healthy food for today and tomorrow, by protecting soil, water, and climate. It promotes
          biodiversity, plant regeneration, wildlife habitat, and dense forest cover which helps to absorb CO2 and regulate global air
          temperatures.</p>
      </div>
    </div>
    <div class='row'>
